...
_LOCAL = (
    "app", "schemas", "netsuite_client",
    "handlers_connection", "handlers_records", "handlers_query",
    "handlers_reports", "panels", "panels_settings",
)
for _mod in _LOCAL:
...
import handlers_records  # noqa: E402,F401
import handlers_query  # noqa: E402,F401
